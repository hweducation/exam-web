...
window.onload = function () {
    var app = new Vue({
        ...
        created(){
            this.searchEntity.type = getParameter("type");
        ...
        methods: {
            //分页查询数据
            findPage(curPage){
                axios.get("/article/findByPage?curPage="+curPage,{params : this.searchEntity}).then((res)=>{
                    if (res.data){
                        //当前页数据列表
            ...
            gotoContent(entity){
                ...
                location.href= "articleDetail.html?id=" +this.entity.id;
            },
