    ...
    var app = new Vue({
        ...
        methods: {
            ...
            answerSubmit(questionList){//答题完毕提交答案
                ...
                //提交按钮样式灰显 background-image: linear-gradient(90deg, rgba(0, 0, 0, 0.17), rgba(149, 163, 220, 0.27));
                document.getElementById("mybutton").style.backgroundImage=("linear-gradient(90deg, rgba(0, 0, 0, 0.17), rgba(149, 163, 220, 0.27))");
            },
